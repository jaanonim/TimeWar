    ...
    <div className={styles.container}>
      <nav className={styles.nav}>
        ...
        <div className={styles.cbox}>
          <p>
            This game was created as school project. It's made with Three.js and
            React.js and use Express.js sever with MongoDb.
          </p>
          <p>Authors:</p>
          <ul>
            <li>
              <a href="https://github.com/n2oneProgrammer">n2one</a>
            </li>
            <li>
